    ...
    <div className='space-y-6 py-16'>
      ...
      >
        ...
        <input
          ...
          placeholder='タイトル'
          className='block w-full py-2 pl-3 pr-4 text-base border border-b-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm'
        />
        <textarea
          value={content}
